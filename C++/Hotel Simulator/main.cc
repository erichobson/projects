...
int testResOverlap(){
    ...
    // 5.7
    // testing duration as 0, should overlap
    Date d11(2023, 1, 1);
    Date d12(2023, 1, 1);
    Reservation r11("Eric", d11, 0);
    Reservation r12("Eric", d12, 1);

    std::cout<<endl;
    if (!resOverlap(r11, r12, true)) score = 0;

    // testing same date, different duration, should overlap
    Date d13(2023, 1, 1);
    Date d14(2023, 1, 1);
    Reservation r13("Eric", d13, 10);
    Reservation r14("Eric", d14, 5);

    std::cout<<endl;
    if (!resOverlap(r13, r14, true)) score = 0;

    // testing same year, same duration, different month, should not overlap
    Date d15(2023, 1, 1);
    Date d16(2023, 2, 1);
    Reservation r15("Eric", d15, 31);
    Reservation r16("Eric", d16, 31);

    std::cout<<endl;
    if (!resOverlap(r15, r16, false)) score = 0;


    // testing different year, same month, same day, year-long duration + 1, should overlap
    Date d17(2023, 1, 1);
    Date d18(2024, 1, 1);
    Reservation r17("Eric", d17, 366);
    Reservation r18("Eric", d18, 10);
