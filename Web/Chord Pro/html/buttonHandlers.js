...
// Functions to handle transpose up and down buttons
function handleTransposeUp() {
    // check whether there is text in the text area
    let textDiv = document.getElementById("text-area")

    // if there is text, transpose up
...
function handleTransposeDown() {
    ...
    // if there is text, transpose down
    if (textDiv.innerHTML != '') {
        transpose("down")
    }
}
